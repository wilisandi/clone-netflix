        ...
        <Transition show={Open} as={Fragment} beforeEnter={()=>{getVideo();getDetail();getSimilar();}}>
            <Dialog as="div" className="relative z-[400]" onClose={closeModal}>
                <Transition.Child
                    ...
                    leaveTo="opacity-0"
                >
                    <div className="fixed inset-0 bg-black/50 blur-md" />
                </Transition.Child>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-start justify-center md:py-10 md:px-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full md:max-w-[50%] md:h-auto h-screen max-w-none transform overflow-hidden rounded-sm bg-black text-left align-middle shadow-xl transition-all md:pb-10 pb-5">
                                    ...
                                    <div className='absolute z-20 bottom-0 pl-8 pr-3 pb-5 w-full flex flex-col md:gap-5 gap-2'>
                                        ...
                                        <div className='w-full flex  items-center justify-between'>
                                            <div className='flex gap-2 text-white'>
                                                <button className='w-15 h-10 px-4 rounded-sm bg-white text-black border border-white focus:border-black focus:outline focus:outline-1 focus:outline-white'><FontAwesomeIcon icon={faPlay} /> Play</button>
