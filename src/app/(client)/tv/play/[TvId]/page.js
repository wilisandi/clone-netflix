...
import { fetchSimilarMovie, fetchSimilarTV, fetchVideoMovie, fetchVideoTv } from '@/lib/api';
...
const TvPlay = ({ params }) => {
    ...
    const getVideo = async () => {
        var video = await fetchVideoTv(params.TvId);
    ...
    const getSimilar = async () => {
        var detail = await fetchSimilarTV(params.TvId);
        if (detail) {
